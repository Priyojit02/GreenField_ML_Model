...
//             Enter any known fields for the opportunity. Leave a field blank if
//             you want the model to estimate it.
//           </Typography>
...
//               }}
//             >
//               {loading ? "Predicting..." : "Predict Missing Fields"}
//             </Button>
...
//                           </TableCell>
//                           <TableCell>
//                             <b>Current Predicted Value (man days)</b>
//                           </TableCell>
//                         </TableRow>
//                       </TableHead>
//                       <TableBody>
...
function App() {
  ...
  const toggleModelChoice = (col) => {
    setUseModel({ ...useModel, [col]: !useModel[col] });
  };
  ...
  const handleEstimate = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://greenfield-ml-model-1b.onrender.com/predict",
        { inputs: finalInputs }
      );
            ...
            {canonicalCols.map((col) => (
              <Grid item xs={12} sm={6} md={4} key={col}>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={useModel[col] || false}
                      onChange={() => toggleModelChoice(col)}
                    />
                  }
                  label="Estimate using model"
                />
              </Grid>
            ))}
          </Grid>
